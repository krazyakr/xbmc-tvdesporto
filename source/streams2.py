...
def pre_resolvers(titles,ligacao,index,nome,tamanho=0,zapping=False):
    ...
    marcador='A iniciar pre_resolvers'
    try:
...
#                comecarvideo(streamurl,nomecanal,True,zapping)
        ...
        #    comecarvideo(streamurl,nomecanal,True,zapping)
            ...
            for chname in ezcast:
                ...
                streamurl='rtmp://' + rtmpendereco + '/live playPath=' + chnum + '?id=' + idnum + ' swfUrl=http://www.ezcast.tv' + swf + ' live=true conn=S:OK swfVfy=1 timeout=14 pageUrl=' + embed
                comecarvideo(streamurl,nomecanal,True,zapping)
        ...
        #        comecarvideo(streamurl,nomecanal,True,zapping)
            ...
            marcador="Catcher: master_tv"; print marcador
        ...
        elif re.search('pepestream.com',link) or re.search('src="http://www.livesportshd.eu/c',link) or re.search('cricfree.sx',link) or re.search('<p><iframe src="http://bit.ly/1lrVcOr"',link) or re.search('tugastream',link) or re.search('sicnoticias_sp.php',link) or re.search('verdirectotv.com/tv',link):
        ...
        #    descobrirresolver("http://www.zuuk.net/ruu.php?nr=" + tuga,nomecanal,False,zapping,nomeserver)
            ...
            for chid in saw:
                ...
                ref_data = {'Referer': embed,'User-Agent':user_agent}
                html= abrir_url_tommy('http://sawlive.tv/embed/watch/' + cont,ref_data)
        ...
        elif re.search('xuscacamusca.se', link) or re.search('fa16bb1eb942c5c48ac3cd66aff4c32f2a015b1af198c14b88',link):
            marcador="Catcher: xuscacamusca.se"; print marcador
            stream4u=re.compile('id="(.+?)";.+?></script>').findall(link)
            for chid in stream4u:
                if re.search('xuscacamusca.se',link):embed='http://xuscacamusca.se/?id='+chid+'&PageSpeed=noscript'
                else:embed='http://fa16bb1eb942c5c48ac3cd66aff4c32f2a015b1af198c14b88.com/gen_s.php?id='+chid#+'&PageSpeed=noscript'
                ref_data = {'Referer': url_frame,'User-Agent':user_agent}
...
def librtmpwindow():
    if selfAddon.getSetting("mensagemlibrtmp100") == "false":
...
def listascanais():
    ...
    addDir("[B]Global[/B] (boxcenter)",'http://boxcenter.altervista.org/teste.m3u',5,tvporpath + art + 'listas-ver2.png',1,'',True)
